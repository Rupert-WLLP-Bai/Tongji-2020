...
int main()
{
	...
	for (int i = 0; i < 365; i++)
	{
		...
		print_title(1);
		for (int i = 1; i <= 3; i++)
			print_first_line(i, M);
		print_rest_line(1, 2, 3, leap_year(year), M);
		print_title(2);
		for (int i = 4; i < 7; i++)
			print_first_line(i, M);
		print_rest_line(4, 5, 6, leap_year(year), M);
		print_title(3);
		for (int i = 7; i <= 9; i++)
			print_first_line(i, M);
		print_rest_line(7, 8, 9, leap_year(year), M);
		print_title(4);
		for (int i = 10; i <= 12; i++)
			print_first_line(i, M);
		print_rest_line(10, 11, 12, leap_year(year), M);
